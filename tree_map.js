...
function TreeMap(baseAspectX, baseAspectY, mergin){
    ...
    self.getDivTree = function(fileTree) {
    ...
    // が小さくなる･･･ と思う
    self.makeDivTree = function(tree) {
    ...
    self.divideRects = function(divNode, divided, rect) {
    ...
    // 描画領域の作成
    self.createTreeMap = function(fileNode, virtWidth, virtHeight, viewPort) {
